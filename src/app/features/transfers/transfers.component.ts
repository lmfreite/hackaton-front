...
@Component({
  ...
  template: `
    <section class="placeholder">
      ...
      <p>Crea, programa y aprueba transferencias entre cuentas corporativas.</p>
      <app-card class="placeholder__card">
        <app-icon name="swap_horiz" [size]="48" color="var(--color-primary)" />
        <h2>Próximamente</h2>
        <p>Esta sección se conectará al motor de pagos del banco en la siguiente iteración.</p>
      </app-card>
    </section>
  `,
  styles: [
